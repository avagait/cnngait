function net = fc_cnn_deploy(net, addSoftMax)
%fc_cnn_deploy  Deploy a CNN
%
% MOD, mjmarin, August/2016: new param to choose adding softmax layer

if ~exist('addSoftMax', 'var')
   addSoftMax = true;
end
...
if addSoftMax
   if isDag
      layers = dagFindLayersOfType(net, 'dagnn.SoftMax');
      if isempty(layers)
